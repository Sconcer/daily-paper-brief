...
### 🎯 语域相关模式（3种，专业文体防"过度人性化"）
25. 自我叙事式导览（报幕，如"先看…""先算…""但先…"）
26. 表演性口语与俚语（如"说白了""泼一盆冷水""露馅"，专业语域中）
27. 绝对化与主观最高级（如"永远""从来""走得最远"，无标准时）

> ⚠️ **先定语域**：模式 25/26/27 是把"个人化文体的解药"误用到专业/技术文体上产生的反向痕迹。动手前先判定文体——专业文体求客观精确，别把口语、个性当"人味"硬加；个人随笔才鼓励口语和第一人称。详见 `SKILL.md` 的"第 0 步"。
...
1. **判定语域** - 先分清专业/技术还是个人/随笔（决定后面力度）
2. **识别 AI 模式** - 对照 `SKILL.md` 中列出的 27 种模式扫描文本
3. **重写问题片段** - 用自然的表达替换 AI 痕迹
4. **保留核心含义** - 确保信息完整性
5. **按语域维持语调** - 专业文体客观精确，个人文体可口语有个性
6. **按语域注入灵魂** - 个人文体让文字有"人味"；专业文体的"人味"是精确 + 可核验的判断，不是口语表演

### 关键原则

#### ✨ 不仅要"干净"，更要"鲜活"——但要看语域

避免 AI 模式只是基础。下面这些"鲜活"手法**只对个人化 / 随笔 / 营销文体全力适用**；对专业 / 技术 / 学术文体，它们是"参考上限"而非目标，用过头会掉进模式 25/26/27（表演性随意）：

- **有观点** - 不要只报告事实，要对它们做出反应
- **变化节奏** - 混合使用长短句（这条对所有文体都适用）
- **承认复杂性** - 真实的人有复杂感受
- **适当使用"我"** - 第一人称是诚实的表现（专业文体里要克制）
- **允许一些混乱** - 完美的结构反而显得机械（专业文体里少用）
- **对感受要具体** - 用具体细节替代抽象概括

> **专业文体的"鲜活"** = 精确 + 有观点 + 可核验的判断。把"走得最远的是 X"这类主观口语，换成"把整条流水线都重构了的是 X"这类落在标准上的判断。
